...
\tabularnewline \hline \hline
 ...
 visible  & Javascript/JQuery boolean expression that can hide the parameter if
...
\tabularnewline \hline \hline
 ...
 contents   & pairs of label:imagecontents information, where imagecontents can 
            ...
            & yes \\ \hline
 style      & css style associated to the gallery, can contain Javascript/JQuery
...
\hline \hline
 ...
 contents  & array of strings, that will be concatenated to form the html 
             content. This content can contain Javascript/JQuery expression using \{\{expr\}\}& yes \\ \hline
...
\subsection{Evaluation of expressions} \label{sec:JavascriptEval}
