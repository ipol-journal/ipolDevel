...
\begin{itemize}
  ...
  \item the functions and methods names are in UpperCamelCase,
...
\lstinputlisting[language=HTML, , firstnumber=18, firstline=18, lastline=48, 
...
../../ipol_demo/static/JQueryApp/ipol_demo.js}
and
\lstinputlisting[language=JavaScript, firstnumber=151,
linerange={151-175}, basicstyle=\scriptsize]{
../../ipol_demo/static/JQueryApp/ipol_demo_upload.js}

\subsubsection{Input demo selection}
...
The demo list is store in the HTML element "demo-select" and once the demo is
