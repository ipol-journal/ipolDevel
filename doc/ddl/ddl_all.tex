...
\begin{itemize}
 ...
 \item local variables declared in a function as accessible by functions inside that function (closure),
...
\begin{itemize}
 ...
 \item \emph{ipol\_servers.js}: this file points to the proxy and the demorunner
  servers. Ideally, only the proxy server should be used, but since we need to upload
  files using a POST method (not available through the proxy) in ipol\_demo\_inputs.js 
 ...
 \item \emph{ipol\_demo\_utils.js}: contains Javascript/JQuery convenient functions.

 \item \emph{ipol\_demo.js}: this file contains the DocumentReady() function,
 ...
 \item \emph{ipol\_demo\_blobs.js}: This file contains the code that renders and 
 ...
 \item \emph{ipol\_demo\_inputs.js}: This file contains the code that renders 
 ...
 \item \emph{ipol\_demo\_run.js}: This file contains the code that, based on the 
 ...
 \item \emph{ipol\_demo\_upload.js}: creates the HTML contents for uploading
 ...
 \item \emph{ipol\_demo\_params.js}: renders and deals with the demo parameters:
 ...
 \item \emph{ipol\_demo\_results.js}: implements the 'DrawResults' class. This
 ...
 \item \emph{ipol\_demo\_archive.js}: renders the information from an demo archive.
 ...
 \item \emph{ipol\_demo\_history.js}: implements the SetPage() function that
 ...
 \item \emph{ipol\_demo\_inpainting.js}: creates the interface needed to draw
  the inpainting mask. It uses a modified version of the 'sketch.js' module.

  \item \emph{ImageGallery/image\_gallery.js}: implements the ImageGallery class
...
../../ipol_demo/static/JQueryApp/ipol_demo.js}
...
../../ipol_demo/static/JQueryApp/ipol_demo_blobs.js}
...
../../ipol_demo/static/JQueryApp/ipol_demo_upload.js}
...
The functions related to the display of the parameters are located in the "ipol\_demo\_params.js"
file and are within the namespace "ipol.params".
