...
The build section can contain a single build description ("\{...\}") or an array 
of build descriptions (''[ \{...\}, \{...\}, ...] ''). Each description has the 
...
\hline \hline
 ...
 binaries   & list of binaries and their associated paths relative to the source 
            ...
            path, where the make command is callled, the second path is the binary
