...
current version is 1.0 \ToDo{[Miguel] Normally you use 1.0 for the first stable version in production, and 0.x for alpha versions.}
...
\tabularnewline \hline \hline
 ...
 input\_condition   & sets a condition on inputs using for example the input sizes 
                        (as input\_size[n] for size (python tuple) of input image number n),
