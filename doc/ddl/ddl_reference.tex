...
of title \emph{Parameters}. However, if a demo needs to group together some parameters,
...
\ToDo{Add a figure showing this layout}
...
\vspace{-1em} & yes \\ \hline
 options    & A set of (key, value) pairs. Currently
              ...
              minimal size of image display. & no \\ \hline
...
\vspace{-1em} & yes \\ \hline
 options    & A set of (key, value) pairs. Currently
              'minwidth' and 'minheight' (in pixels) options are available to force
              minimal size of video display. & no \\ \hline
