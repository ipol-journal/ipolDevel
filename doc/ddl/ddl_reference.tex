...
The inputs section describes the set of input data of the algorithm (images, videos or data). If your demo does not use inputs, include an empty list in your DDL.
