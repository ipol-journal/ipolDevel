...
\begin{figure}[H]
  ...
  \caption{Database schema for the Blobs module. \ToDo{[Miguel] Was this diagram made with an automatic tool? In that case, which tool? It needs to be a vectorial graphic, not raster. In general, using an automatic tool which creates automatically the diagram is a very good idea.}}
  %\footnotesize
