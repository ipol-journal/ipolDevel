...
\ToDo{[Miguel] The field \emph{blob\_id\_in\_set} has a bad name. Its name suggests that it is an ID (a PK or FK), but instead it is a position. I propose to change it to \emph{blob\_pos\_in\_set} or similar.}
