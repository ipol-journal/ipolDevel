...
The user will be able to monitor if the modules are running and in what machine they are running.This will be done using the ping or stats ws provided by the different modules.
...
The Archive module is responsible for storing the experiments made by users. When a user select a file of his own instead of using one of the files proposed by the demo, This file is uploaded and used to run the demo by Demo module, then the result of this execution is sent to Archive module to be stored. Some demos have 40000 experiments.
...
The Demo execution system consists of a Demo Dispatcher module, a Demo Runner module and a DemoInfo module.
...
To login just access the following URL, if you were already logged in, it will redirect you to the status page.
...
with this user create all other accounts.
Remember to run all migrations!


% The Control Panel Module Technical Info
\input{technical_information.tex}
