...
In this module the users will be presented with a list of all the demos stored in the database. For each demo displayed, the users will be able to manage all the information available.
\begin{itemize}
\item Add new demo 
button allows the user to create a new demo in the data base.
\item DDL 
button allows the user to see and edit the DDL of the selected demo.
\item Authors 
button allows the user to see the authors of the selected demo and add an existing author or create a new one.
\item Editors 
button allows the user to see the editors of the selected demo and add an existing editor or create a new one.
\item Demo Extras 
button allows the user to manage the demo extra of the selected demo.
\item Delete 
button allows the user to remove the demo from de data base.
\item Edit 
button allows the user to change the general description of the demo.
\end{itemize}
