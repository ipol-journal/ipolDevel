...
This document contains the technical documentation for the Demo Web interface 3.0 that lets the user test demos and their results. This interface provides utility controlls such as mask blob editing, image cropping, zoom and blob reproduction.
