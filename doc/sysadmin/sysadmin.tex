...
This script synchonizes a copy of the {\tt ipolDevel/} folder and takes care of exporting all the SQLite database files.This allows recovering important data in the case of a fatal disk failure or any major problem.
