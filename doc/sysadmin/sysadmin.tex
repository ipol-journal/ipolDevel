...
\begin{itemize}
    ...
    \item \textbf{pdflatex report}: the script {\tt ipolDevel/ci\_tests/pdflatex.sh} checks if the LaTeX documentation of the project compiles and sends an email otherwise.
