...
The system needs several packages from the Debian Stable distribution and also from the official Python packages to work.
Tools are provided to ease installation in : 
\begin{verbatim}
cd ipol/sysadmin/install_packages/
\end{verbatim}

Find and apply the list of apt-get packages, they can be installed with the following command:
\begin{verbatim}
