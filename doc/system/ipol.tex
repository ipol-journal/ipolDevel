...
\textbf{Software engineers and external consultants, past and present (in alphabetical order):}
...
Packages to be installed with pip install: \miguel{This should be put in a requirements.txt file and here document only how to use that file.}
\begin{itemize}
\item python-magic
\item pypng
\item numpy
