...
In this section we add general comments on the projects, parts which still needed to be written or coded. In general, information which needs to be documented but has not still found its place in the document. It works as a reminder not to forget.
...
\begin{itemize}
    ...
    \item Document the format of the demo package, with desc.json, images/, extra/, etc
