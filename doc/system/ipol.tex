...
- Backups. For the moment we use the very simple script at ipolDevel/sysadmin/backup.sh
...
- Add a cleanup script to delete temporal files older than, say, one month.
