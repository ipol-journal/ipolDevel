...
It follows now a list of all the webservices implemented by the blobs module: \miguel{ToDo: it's OK to have for the moment this list of services, but in the near future we'll get them from the automatic documentation script.}
