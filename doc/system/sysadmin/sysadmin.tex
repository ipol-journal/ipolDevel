...
- Reboot. The script {\tt ipolDevel/sysadmin/on\_reboot.sh} starts all IPOL modules and nginx on reboot and send an email to inform about the reboot. 
To execute it, the following line needs to be added with {\tt crontab -e} as root.
