...
class BlobsTests(unittest.TestCase):
    ...
    def test_add_blob_to_demo_without_visual_representation(self):
        ...
        try:
            with open(self.blob_path, "rb") as blob:
                json_response = self.add_blob_to_demo(
                    blob=blob,
            ...
            try:
                blob_list = (
                    json_response.get("sets")[0].get("blobs").get(str(self.pos_in_set))
                )
    ...
    def test_add_blob_to_template_without_visual_representation(self):
        ...
        try:
            ...
            with open(self.blob_path, "rb") as blob:
                json_response = self.add_blob_to_template(
                    blob=blob,
    ...
    def test_remove_blob_from_demo(self):
        ...
        try:
            ...
            response = self.remove_blob_from_demo(
    ...
    def test_remove_blob_from_template(self):
        ...
        try:
            ...
            response = self.remove_blob_from_template(
    ...
    def test_edit_blob_from_demo(self):
        ...
        try:
            ...
            response = self.edit_blob_from_demo(
                demo_id=self.demo_id,
                blob_set=self.blob_set,
            ...
            try:
                blob_list = (
                    json_response.get("sets")[0].get("blobs").get(str(new_pos_in_set))
                )
    ...
    def test_edit_blob_from_template(self):
        ...
        try:
            ...
            response = self.edit_blob_from_template(
                template_id=template_id,
                title=new_title,
                blob_set=self.blob_set,
                new_blob_set=new_set,
    ...
    def add_blob_to_demo(
        ...
        response = self.post(
            self.module, "add_blob_to_demo", params=params, files=files
        )
    ...
    def add_blob_to_template(
        ...
        if blob_vr is not None:
            files["blob_vr"] = blob_vr
        response = self.post(
            self.module, "add_blob_to_template", params=params, files=files
        )
        return response.json()
    ...
    def edit_blob_from_demo(
        ...
        if vr is not None:
            files["blob_vr"] = vr
        response = self.post(
            self.module, "edit_blob_from_demo", params=params, files=files
        )
        return response.json()
    ...
    def edit_blob_from_template(
        ...
        if vr is not None:
            files["blob_vr"] = vr
        response = self.post(
            self.module, "edit_blob_from_template", params=params, files=files
        )
        return response.json()
