...
TIMEFORMAT="stufftime %R s"

echo time  test_clgof a.png b.png $ALPHA $RHO $SIGMA $NUMIT $W $NUMSCALES $ZOOMFACTOR $COUPLEDMODE $VERBOSE ${P}.tiff
{ time  test_clgof agray.png bgray.png $ALPHA $RHO $SIGMA $NUMIT $W $NUMSCALES $ZOOMFACTOR $COUPLEDMODE $VERBOSE ${P}.tiff; } 2> ${P}.stime
