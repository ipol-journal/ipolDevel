...
#loqpasoaposter="{'inputs': [{'description': 'input', 'max_pixels': '700 * 700', 'dtype': '3x8i', 'ext': '.png', 'type': 'image', 'max_weight': '10 * 1024 * 1024'}], 'results': [{'style': 'height:{{sizeY*ZoomFactor}}px', 'type': 'gallery', 'contents': {'Input': 'input_0.sel.png', 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=3': 'output-am_3.png', 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=5': 'output-am_5.png', 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=4': 'output-am_4.png', 'DCT': 'output-dct.png', 'FIR, <i>tol<\\\\/i>=10<sup>&minus;2<\\\\/sup>': 'output-fir.png', 'Exact*': 'output-exact.png', 'Box, <i>K<\\\\/i>=3': 'output-box_3.png', 'Box, <i>K<\\\\/i>=4': 'output-box_4.png', 'Box, <i>K<\\\\/i>=5': 'output-box_5.png', 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=5': 'output-vyv_5.png', 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=4': 'output-vyv_4.png', 'Extended box, <i>K<\\\\/i>=3': 'output-ebox_3.png', 'Extended box, <i>K<\\\\/i>=4': 'output-ebox_4.png', 'Extended box, <i>K<\\\\/i>=5': 'output-ebox_5.png', 'Vliet&
ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=3': 'output-vyv_3.png', 'SII, <i>K<\\\\/i>=3': 'output-sii_3.png', 'SII, <i>K<\\\\/i>=4': 'output-sii_4.png', 'SII, <i>K<\\\\/i>=5': 'output-sii_5.png', 'Deriche, <i>K<\\\\/i>=3': 'output-deriche_3.png', 'Deriche, <i>K<\\\\/i>=2': 'output-deriche_2.png', 'Deriche, <i>K<\\\\/i>=4': 'output-deriche_4.png'}, 'label': 'Images:'}, {'type': 'html_text', 'contents': [\"<p style='font-size:85%'>* &ldquo;Exact&rdquo; is computed with FIR, \", '<i>tol<\\\\/i>=10<sup>&minus;15<\\\\/sup>, for &sigma;&nbsp;&le;&nbsp;2 and ', 'DCT for &sigma;&nbsp;&gt;&nbsp;2 ', \"(using {{params.sigma<=2?'FIR':'DCT'}} for this experiment).<\\\\/p>\"]}, {'type': 'html_text', 'contents': ['<h2>Accuracy<\\\\/h2>', \"<table style='margin:0px;margin-top:10px;text-align:center'>\", '<tr>', '<th>Method<\\\\/th>', '<th>&nbsp;Max Diff&nbsp;<\\\\/th>', '<th>&nbsp;RMSE&nbsp;<\\\\/th>', '<th>&nbsp;PSNR&nbsp;<\\\\/th>', '<\\\\/tr>', '<tr ng-repeat=\\'(k,v) in info\\' ng-if=\\'k.indexOf(\"metrics_\")>-1\\'', 'ng-
init=\\'alg={ \"fir\":\"FIR, <i>tol<\\\\/i>=10<sup>&minus;2<\\\\/sup>\", \"dct\":\"DCT\", \"box\":\"Box\", \"ebox\":\"Extended box\", \"sii\":\"SII\", \"deriche\":\"Deriche\" , \"vyv\":\"Vliet&ndash;Young&ndash;Verbeek\", \"am\":\"Alvarez&ndash;Mazorra\" }\\'>', '<td>', '<span ng-bind-html=\"alg[k.substr(8).split(\\'_\\')[0]]\"> <\\\\/span>', '<span ng-if=\"k.substr(8).split(\\'_\\').length>1\">', \", <i>K<\\\\/i>= {{k.substr(8).split('_')[1]}}\", '<\\\\/span>', '<\\\\/td>', \"<td> {{v.split('|')[0].split(':')[1]}} <\\\\/td>\", \"<td> {{v.split('|')[1].split(':')[1]}} <\\\\/td>\", \"<td> {{v.split('|')[2].split(':')[1]}} <\\\\/td>\", '<\\\\/tr>', '<\\\\/table>']}], 'params': [{'values': {'default': 5, 'max': 30, 'step': 0.01, 'min': 0.5}, 'type': 'range', 'id': 'sigma', 'label': '<i>&sigma;<\\\\/i>, Gaussian standard deviation'}, {'default': ['fir', 'dct'], 'values': [{'fir': 'FIR, <i>tol<\\\\/i>=10<sup>&minus;2<\\\\/sup>'}, {'dct': 'DCT'}, {'box_5': 'Box, <i>K<\\\\/i>=5', 'box_4': 'Box, <i>K<\\\\/i>=4', '
box_3': 'Box, <i>K<\\\\/i>=3'}, {'ebox_3': 'Extended box, <i>K<\\\\/i>=3', 'ebox_5': 'Extended box, <i>K<\\\\/i>=5', 'ebox_4': 'Extended box, <i>K<\\\\/i>=4'}, {'sii_3': 'SII, <i>K<\\\\/i>=3', 'sii_5': 'SII, <i>K<\\\\/i>=5', 'sii_4': 'SII, <i>K<\\\\/i>=4'}, {}, {'am_3': 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=3', 'am_5': 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=5', 'am_4': 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=4'}, {'deriche_4': 'Deriche, <i>K<\\\\/i>=4', 'deriche_2': 'Deriche, <i>K<\\\\/i>=2', 'deriche_3': 'Deriche, <i>K<\\\\/i>=3'}, {'vyv_3': 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=3', 'vyv_5': 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=5', 'vyv_4': 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=4'}], 'type': 'checkboxes', 'id': 'algo', 'label': 'Algorithms'}], 'build': [{'url': 'http://www.ipol.im/pub/art/2013/87/gaussian_20131215.tgz', 'srcdir': 'gaussian_20131215', 'binaries': [['.', 'gaussian_demo'], ['.', 'imdiff']], 'flags': '-j4  --makefile=makefile.gcc', 'build_type': 'make'}], 'run': ['run_
algorithms.py'], 'config': {'info_from_file': {'metrics_box_3': 'metrics_box_3.txt', 'metrics_box_5': 'metrics_box_5.txt', 'metrics_box_4': 'metrics_box_4.txt', 'metrics_deriche_3': 'metrics_deriche_3.txt', 'metrics_dct': 'metrics_dct.txt', 'metrics_deriche_2': 'metrics_deriche_2.txt', 'metrics_fir': 'metrics_fir.txt', 'metrics_sii_4': 'metrics_sii_4.txt', 'metrics_sii_3': 'metrics_sii_3.txt', 'metrics_am_3': 'metrics_am_3.txt', 'metrics_vyv_3': 'metrics_vyv_3.txt', 'metrics_deriche_4': 'metrics_deriche_4.txt', 'metrics_vyv_5': 'metrics_vyv_5.txt', 'metrics_am_5': 'metrics_am_5.txt', 'metrics_vyv_4': 'metrics_vyv_4.txt', 'metrics_ebox_5': 'metrics_ebox_5.txt', 'metrics_ebox_4': 'metrics_ebox_4.txt', 'metrics_sii_5': 'metrics_sii_5.txt', 'metrics_ebox_3': 'metrics_ebox_3.txt', 'metrics_am_4': 'metrics_am_4.txt'}}, 'archive': {'files': {'output-deriche_2.png': 'output deriche_2', 'output-deriche_3.png': 'output deriche_3', 'output-sii_5.png': 'output sii_5', 'output-ebox_4.png': 'output ebox_4', 'output-am_3.
png': 'output am_3', 'output-fir.png': 'output fir', 'output-box_4.png': 'output box_4', 'output-sii_3.png': 'output sii_3', 'output-vyv_5.png': 'output vyv_5', 'output-vyv_4.png': 'output vyv_4', 'output-box_3.png': 'output box_3', 'input_0.orig.png': 'uploaded image', 'output-vyv_3.png': 'output vyv_3', 'output-box_5.png': 'output box_5', 'output-am_5.png': 'output am_5', 'output-am_4.png': 'output am_4', 'input_0.sel.png': 'selected subimage', 'output-dct.png': 'output dct', 'output-deriche_4.png': 'output deriche_4', 'output-ebox_5.png': 'output ebox_5', 'output-sii_4.png': 'output sii_4', 'output-ebox_3.png': 'output ebox_3'}, 'params': ['sigma', 'fir', 'dct', 'box_3', 'box_4', 'box_5', 'ebox_3', 'ebox_4', 'ebox_5', 'sii_3', 'sii_4', 'sii_5', 'am_3', 'am_4', 'am_5', 'deriche_2', 'deriche_3', 'deriche_4', 'vyv_3', 'vyv_4', 'vyv_5']}, 'general': {'demo_title': 'A Survey of Gaussian Convolution Algorithms', 'xlink_article': 'http://www.ipol.im/pub/art/2013/87/', 'param_description': ['']
, 'input_description': ''}}"
#json81="{'inputs': [{'description': 'input', 'max_pixels': '700 * 700', 'dtype': '3x8i', 'ext': '.png', 'type': 'image', 'max_weight': '10 * 1024 * 1024'}], 'results': [{'style': 'height:{{sizeY*ZoomFactor}}px', 'type': 'gallery', 'contents': {'Input': 'input_0.sel.png', 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=3': 'output-am_3.png', 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=5': 'output-am_5.png', 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=4': 'output-am_4.png', 'DCT': 'output-dct.png', 'FIR, <i>tol<\\\\/i>=10<sup>&minus;2<\\\\/sup>': 'output-fir.png', 'Exact*': 'output-exact.png', 'Box, <i>K<\\\\/i>=3': 'output-box_3.png', 'Box, <i>K<\\\\/i>=4': 'output-box_4.png', 'Box, <i>K<\\\\/i>=5': 'output-box_5.png', 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=5': 'output-vyv_5.png', 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=4': 'output-vyv_4.png', 'Extended box, <i>K<\\\\/i>=3': 'output-ebox_3.png', 'Extended box, <i>K<\\\\/i>=4': 'output-ebox_4.png', 'Extended box, <i>K<\\\\/i>=5': 'output-ebox_5.png', 'Vliet&ndash;Young&
ndash;Verbeek, <i>K<\\\\/i>=3': 'output-vyv_3.png', 'SII, <i>K<\\\\/i>=3': 'output-sii_3.png', 'SII, <i>K<\\\\/i>=4': 'output-sii_4.png', 'SII, <i>K<\\\\/i>=5': 'output-sii_5.png', 'Deriche, <i>K<\\\\/i>=3': 'output-deriche_3.png', 'Deriche, <i>K<\\\\/i>=2': 'output-deriche_2.png', 'Deriche, <i>K<\\\\/i>=4': 'output-deriche_4.png'}, 'label': 'Images:'}, {'type': 'html_text', 'contents': [\"<p style='font-size:85%'>* &ldquo;Exact&rdquo; is computed with FIR, \", '<i>tol<\\\\/i>=10<sup>&minus;15<\\\\/sup>, for &sigma;&nbsp;&le;&nbsp;2 and ', 'DCT for &sigma;&nbsp;&gt;&nbsp;2 ', \"(using {{params.sigma<=2?'FIR':'DCT'}} for this experiment).<\\\\/p>\"]}, {'type': 'html_text', 'contents': ['<h2>Accuracy<\\\\/h2>', \"<table style='margin:0px;margin-top:10px;text-align:center'>\", '<tr>', '<th>Method<\\\\/th>', '<th>&nbsp;Max Diff&nbsp;<\\\\/th>', '<th>&nbsp;RMSE&nbsp;<\\\\/th>', '<th>&nbsp;PSNR&nbsp;<\\\\/th>', '<\\\\/tr>', '<tr ng-repeat=\\'(k,v) in info\\' ng-if=\\'k.indexOf(\"metrics_\")>-1\\'', 'ng-init=\\'
alg={ \"fir\":\"FIR, <i>tol<\\\\/i>=10<sup>&minus;2<\\\\/sup>\", \"dct\":\"DCT\", \"box\":\"Box\", \"ebox\":\"Extended box\", \"sii\":\"SII\", \"deriche\":\"Deriche\" , \"vyv\":\"Vliet&ndash;Young&ndash;Verbeek\", \"am\":\"Alvarez&ndash;Mazorra\" }\\'>', '<td>', '<span ng-bind-html=\"alg[k.substr(8).split(\\'_\\')[0]]\"> <\\\\/span>', '<span ng-if=\"k.substr(8).split(\\'_\\').length>1\">', \", <i>K<\\\\/i>= {{k.substr(8).split('_')[1]}}\", '<\\\\/span>', '<\\\\/td>', \"<td> {{v.split('|')[0].split(':')[1]}} <\\\\/td>\", \"<td> {{v.split('|')[1].split(':')[1]}} <\\\\/td>\", \"<td> {{v.split('|')[2].split(':')[1]}} <\\\\/td>\", '<\\\\/tr>', '<\\\\/table>']}], 'params': [{'values': {'default': 5, 'max': 30, 'step': 0.01, 'min': 0.5}, 'type': 'range', 'id': 'sigma', 'label': '<i>&sigma;<\\\\/i>, Gaussian standard deviation'}, {'default': ['fir', 'dct'], 'values': [{'fir': 'FIR, <i>tol<\\\\/i>=10<sup>&minus;2<\\\\/sup>'}, {'dct': 'DCT'}, {'box_5': 'Box, <i>K<\\\\/i>=5', 'box_4': 'Box, <i>K<\\\\/i>=4', 'box_3': '
Box, <i>K<\\\\/i>=3'}, {'ebox_3': 'Extended box, <i>K<\\\\/i>=3', 'ebox_5': 'Extended box, <i>K<\\\\/i>=5', 'ebox_4': 'Extended box, <i>K<\\\\/i>=4'}, {'sii_3': 'SII, <i>K<\\\\/i>=3', 'sii_5': 'SII, <i>K<\\\\/i>=5', 'sii_4': 'SII, <i>K<\\\\/i>=4'}, {}, {'am_3': 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=3', 'am_5': 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=5', 'am_4': 'Alvarez&ndash;Mazorra, <i>K<\\\\/i>=4'}, {'deriche_4': 'Deriche, <i>K<\\\\/i>=4', 'deriche_2': 'Deriche, <i>K<\\\\/i>=2', 'deriche_3': 'Deriche, <i>K<\\\\/i>=3'}, {'vyv_3': 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=3', 'vyv_5': 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=5', 'vyv_4': 'Vliet&ndash;Young&ndash;Verbeek, <i>K<\\\\/i>=4'}], 'type': 'checkboxes', 'id': 'algo', 'label': 'Algorithms'}], 'build': [{'url': 'http://www.ipol.im/pub/art/2013/87/gaussian_20131215.tgz', 'srcdir': 'gaussian_20131215', 'binaries': [['.', 'gaussian_demo'], ['.', 'imdiff']], 'flags': '-j4  --makefile=makefile.gcc', 'build_type': 'make'}], 'run': ['run_algorithms.py'
], 'config': {'info_from_file': {'metrics_box_3': 'metrics_box_3.txt', 'metrics_box_5': 'metrics_box_5.txt', 'metrics_box_4': 'metrics_box_4.txt', 'metrics_deriche_3': 'metrics_deriche_3.txt', 'metrics_dct': 'metrics_dct.txt', 'metrics_deriche_2': 'metrics_deriche_2.txt', 'metrics_fir': 'metrics_fir.txt', 'metrics_sii_4': 'metrics_sii_4.txt', 'metrics_sii_3': 'metrics_sii_3.txt', 'metrics_am_3': 'metrics_am_3.txt', 'metrics_vyv_3': 'metrics_vyv_3.txt', 'metrics_deriche_4': 'metrics_deriche_4.txt', 'metrics_vyv_5': 'metrics_vyv_5.txt', 'metrics_am_5': 'metrics_am_5.txt', 'metrics_vyv_4': 'metrics_vyv_4.txt', 'metrics_ebox_5': 'metrics_ebox_5.txt', 'metrics_ebox_4': 'metrics_ebox_4.txt', 'metrics_sii_5': 'metrics_sii_5.txt', 'metrics_ebox_3': 'metrics_ebox_3.txt', 'metrics_am_4': 'metrics_am_4.txt'}}, 'archive': {'files': {'output-deriche_2.png': 'output deriche_2', 'output-deriche_3.png': 'output deriche_3', 'output-sii_5.png': 'output sii_5', 'output-ebox_4.png': 'output ebox_4', 'output-am_3.png': 'output 
am_3', 'output-fir.png': 'output fir', 'output-box_4.png': 'output box_4', 'output-sii_3.png': 'output sii_3', 'output-vyv_5.png': 'output vyv_5', 'output-vyv_4.png': 'output vyv_4', 'output-box_3.png': 'output box_3', 'input_0.orig.png': 'uploaded image', 'output-vyv_3.png': 'output vyv_3', 'output-box_5.png': 'output box_5', 'output-am_5.png': 'output am_5', 'output-am_4.png': 'output am_4', 'input_0.sel.png': 'selected subimage', 'output-dct.png': 'output dct', 'output-deriche_4.png': 'output deriche_4', 'output-ebox_5.png': 'output ebox_5', 'output-sii_4.png': 'output sii_4', 'output-ebox_3.png': 'output ebox_3'}, 'params': ['sigma', 'fir', 'dct', 'box_3', 'box_4', 'box_5', 'ebox_3', 'ebox_4', 'ebox_5', 'sii_3', 'sii_4', 'sii_5', 'am_3', 'am_4', 'am_5', 'deriche_2', 'deriche_3', 'deriche_4', 'vyv_3', 'vyv_4', 'vyv_5']}, 'general': {'demo_title': 'A Survey of Gaussian Convolution Algorithms', 'xlink_article': 'http://www.ipol.im/pub/art/2013/87/', 'param_description': [''], 'input_
description': ''}}"
emptyjson = {}
