...
class TestDemoinfo(unittest.TestCase):
	...
	def add_demo_description_2(self):
		test_passed = True
		try:
			...
			print
			print (" This tests attacs DemoInfo module, so it DemoInfo must be running, its a more realistic test than the rest")
			print (" This tests attacs the real DB, not the test DB. Adds a demo description js to DB and reads it")
			print
			...
			r = requests.post(url, json=demojson)

			print (" add_demo_description RESULT")
			print " url: ",r.url
			print " text: ",r.text
			...
			print (" update_demo_description RESULT")
			# print " url: ",r.url
			# print " text: ",r.text
			# print " headers: ",r.headers.get('content-type')
			# print " result: ",r
			...
			print "add_demo_description_2 ",ex
			test_passed = False
	...
	def edit_demo(self):
		...
		try:
			...
			json_demo_1='{"modification": "2015-12-02 13:24:43", "title": "newdemo1", "abstract": "newdemo1abstract", "demodescriptionID":1, "creation": "2015-12-02 13:24:43", "editorsdemoid": 1, "active": 1, "stateID": 1, "id": 1, "zipURL": "http://demo1updated.com"}'
	...
	def test_steps(self):
		...
		try:
			...
			print " ---16 SPECIAL TEST, DEMOINFO MODULE MUST BE RUNNING"
