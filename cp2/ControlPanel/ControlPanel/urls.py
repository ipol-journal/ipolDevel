...
urlpatterns = [
    path('cp2/', include([
        ...
        path('password_reset/', password_reset, name='password/password_reset.html'),
        ...
        path('createBlob/ajax', ajax_add_blob_template),
        path('createBlob/ajax_demo', ajax_add_blob_demo),
        ...
        path('removeBlob/ajax_remove_blob_from_demo', ajax_remove_blob_from_demo, name='remove_blob_demo'),
        path('removeBlob/ajax_remove_blob_from_template', ajax_remove_blob_from_template, name='remove_blob_template'),
        ...
        path('showBlobsDemo/ajax_remove_template_to_demo', ajax_remove_template_to_demo),
        path('demoExtras', demoExtras),
        path('demoExtras/ajax_add_demo_extras', ajax_add_demo_extras, name='add_extras'),
        path('demoExtras/ajax_delete_demo_extras', ajax_delete_demo_extras, name='delete_extras'),
        path('showArchive', show_archive, name='archive'),
        path('showExperiment', show_experiment, name='showExperiment'),
        path('ajax_delete_experiment', ajax_delete_experiment, name='delete_experiment'),
    ]))
]
